...
class tutorial_urukulFreqScan(EnvExperiment):
    ...
    def build(self): #This code runs on the host device
        ...
        self.setattr_argument("freq", NumberValue(ndecimals=0, step=1))        
    ...
    def run(self):  
        ...
        self.urukul0_ch1.set(self.freq * MHz, amplitude = amp)             #writes frequency and amplitude variables to urukul channel thus outputting function
        delay(2*s)                                              #2s delay
